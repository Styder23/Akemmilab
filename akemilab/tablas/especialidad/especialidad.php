...
<body>
    <h1 class="text-center">Especialidades de Médicos</h1>
            ...
            $.ajax({
                ...
                success: function(data) {
                    try {
                        ...
                        if (json) {
                            $('#idexamen').val(json.idespecialidad);
                            $('#_area').val(json.nombre);
                        ...
                        try {
                            ...
                            if (json.status === 'true') {
                                ...
                                Swal.fire({
                                    icon: 'success',
                                    title: 'Éxito',
                                    text: 'Especialidad eliminado correctamente'
                                });
                            } else {
                                Swal.fire({
                                    icon: 'error',
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="agregarexamenLabel">Agregar Especialidad</h5>
                ...
                <form id="frmexam" action="javascript:void(0);" method="POST">
                    <div class="modal-body">
                        <!-- Formulario -->
                        <div class="mb-3 row">
                            <label for="examen" class="col-sm-2 col-form-label">Especialidad</label>
                            <div class="col-sm-10">
                                <input type="text" name="area" class="form-control" id="area"
                                    placeholder="Ingrese especialidad" required>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="editexmmodal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editExamModalLabel">Modificar Especialidad</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Cerrar"></button>
                </div>
                <form id="editExamenForm" action="javascript:void(0);" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="mb-3 row">
                            <label for="_examen" class="col-sm-2 col-form-label">Especialidad</label>
                            <div class="col-sm-10">
