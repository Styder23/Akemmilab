...
while ($row = mysqli_fetch_assoc($resultado)) {
    $data[] = [
        $row['idespecialidad'],
        $row['nombre'],
        '<button class="btn btn-info btn-sm editbtn" data-idarea="' . $row['idespecialidad'] . '">Editar</button> ' .
        '<button class="btn btn-danger btn-sm deleteBtn" data-idarea="' . $row['idespecialidad'] . '">Eliminar</button>'
    ];
}
