            ...
            $.ajax({
                ...
                success: function(data) {
                    try {
                        ...
                        if (json) {
                            $('#idexamen').val(json.idarea);
                            $('#_area').val(json.nomarea);
                    ...
                    try {
                        ...
                        if (json.status === 'true') {
                            ...
                            Swal.fire({
                                icon: 'success',
                                title: 'Éxito',
                                text: 'area clinica editada correctamente'
                            });
        ...
        $(document).on('click', '.deleteBtn', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: './deleteaea.php', // Cambia esto por la URL de tu script PHP para eliminar áreas
                        method: 'POST',
                        data: {
                            id: idarea
                        },
