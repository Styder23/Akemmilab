...
while ($row = mysqli_fetch_assoc($resultado)) {
    $data[] = [
        $row['unidades'],
        '<button class="btn btn-info btn-sm editbtn" data-idarea="' . $row['idunidades'] . '">Editar</button> ' .
        '<button class="btn btn-danger btn-sm deleteBtn" data-idarea="' . $row['idunidades'] . '">Eliminar</button>'
    ];
}
