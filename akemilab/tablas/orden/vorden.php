...
while ($row = mysqli_fetch_assoc($result)) {
    $data[] = [
        ...
        $row['codorden'],
        $row['fecha'],
        '<button class="btn btn-success btn-sm verBtn" data-idorden="' . $row['idorden'] . '">Ver</button> '.
        '<button class="btn btn-danger btn-sm delBtn" data-idorden="' . $row['idorden'] . '">Eliminar</button>'
    ];
    $count++;
}
