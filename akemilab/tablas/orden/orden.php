...
<body>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.verBtn', function() {
            ...
            var form = $('<form action="reorden.php" method="post">' +
        ...
        // Función para eliminar el Orden
        $(document).on('click', '.delBtn', function() {
            ...
            if (confirm("¿Estás seguro de que deseas eliminar este dato?")) {
                ...
                $.ajax({
                    url: './delorden.php', // Cambia esto por la URL de tu script PHP para eliminar pacientes
                    method: 'POST',
                    data: {
                    ...
                    success: function(data) {
                        try {
                            ...
                            if (json.status === 'true') {
                                ...
                                alert('Error al eliminar el Orden Clínico');
                            }
                        } catch (e) {
